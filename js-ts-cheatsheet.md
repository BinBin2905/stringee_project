...
// ── Switch ──
switch (code) {
  case 1: console.log("Calling"); break;
  case 2: console.log("Ringing"); break;
  case 3: console.log("Answered"); break;
...
function handleAction(a: Action) {
  switch (a.action) {
    case "record":  console.log(a.format); break;   // TS biết có format
    case "connect": console.log(a.from); break;      // TS biết có from
    case "talk":    console.log(a.text); break;       // TS biết có text
  }
}
```
