...
// (e.g. lib/stringee-sdk.ts). The <Toaster /> component subscribes and
// renders the queue with daisyUI's `toast` + `alert` classes.
...
export interface ToastMessage {
  ...
  kind: ToastKind;
  text: string;
  duration: number; // ms; the Toaster removes after this elapses
}
